...
<!-- PORTMASTER_REPACK_REMOVE_START -->
This repository also builds **Balatro Lite for Android**. The Android app uses the same small-screen patches but remains independently named and packaged, so existing Android installations keep their application identity and update path.
<!-- PORTMASTER_REPACK_REMOVE_END -->
...
<!-- PORTMASTER_REPACK_REMOVE_START -->
- **Or an Android device** on which you can sideload the Balatro Lite release APK.
<!-- PORTMASTER_REPACK_REMOVE_END -->
...
<!-- PORTMASTER_REPACK_REMOVE_START -->
- The Android build applies its selected layout and performance settings while importing the game; PortMaster's launcher-driven setup described above is specific to PortMaster.
<!-- PORTMASTER_REPACK_REMOVE_END -->
